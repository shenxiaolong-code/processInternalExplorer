...
1. add $(solutionName)_setting.props file in .sln directory
   property file "msvc\vs2017\properties_sheet\general_setting\path_setting.props" will search&load it automatically.
   e.g.  similiar file "Features_vs2017_setting.props"
